...
const Contact = () => {
    ...
    const ser = process.env.REACT_APP_EMAILJS_SERVICE_ID;
    const tem = process.env.REACT_APP_EMAILJS_TEMPLATE_ID;
    const pub = process.env.REACT_APP_EMAILJS_PUBLIC_USER_ID;
